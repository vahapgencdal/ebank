...
public class AccountMockCreater {
    ...
    public static BankAccount getIsBankOwnAccount(long currencyId, long accountType, long bankId, boolean isDefault) {
    ...
    public static BankAccount getGarantiOwnAccount(long userId, long currencyId, long accountType, long bankId, boolean isDefault) {
    ...
    public static UserAccount getUserAccount(long userId, long currencyId, long accountType, String name, long bankId, boolean isDefault, long totalAmount) {
